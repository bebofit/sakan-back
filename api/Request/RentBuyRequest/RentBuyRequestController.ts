...
class RentBuyRequestController {
  ...
  async createRentBuyRequest(
    ...
    return Http.sendResponse(
      ...
      httpStatus.CREATED,
      rentBuyReq,
      'Rent/Buy Property Request Created Successfully'
    );
  }

  async getAllRentBuyRequests(
    request: IRequest,
    response: Response
  ): Promise<any> {
    ...
    return Http.sendResponse(
      ...
      httpStatus.OK,
      rentBuyReqs,
      'Rent/Buy Property Requests Found'
    );
  }
  ...
  async getRentBuyRequest(request: IRequest, response: Response): Promise<any> {
    ...
    return Http.sendResponse(
      ...
      httpStatus.OK,
      rentBuyReq,
      'Rent/Buy Property Request Found'
    );
  }

  async updateRentBuyRequest(
    request: IRequest,
    response: Response
  ): Promise<any> {
    let rentBuyReq;
    ...
    return Http.sendResponse(
      ...
      httpStatus.OK,
      rentBuyReq,
      'Rent/Buy Property Request Updated Successfully'
    );
  }

  async deleteRentBuyRequest(
    request: IRequest,
    response: Response
  ): Promise<any> {
    ...
    return Http.sendResponse(
      ...
      httpStatus.OK,
      rentBuyReq,
      'Rent/Buy Property Request Deleted Successfully'
    );
  }
}
